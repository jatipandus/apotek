...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-4">
                            <div class="sm-st clearfix">
                                ...
                                <?php $tampil=$conn->query("select * from data_penduduk order by id desc");
                                      $hit=0;
                        ...
                        <div class="col-md-4">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                <?php $tampil1=$conn->query("select * from data_penduduk order by id desc");
                                $hit1=0;
                        ...
                        <div class="col-md-8">
                            ...
                            <section class="panel">
                                <header class="panel-heading">
                                    ...
                                    <?php 
                                    $query1="select id,nama,tgl_lahir,status_cetak, YEAR(curdate()) - YEAR(tgl_lahir) AS usia from data_penduduk where asal = 'asli' and ket = 'hidup' order by id desc limit 7;";
                                ...
                                <div class="panel-body">
                                   ...
                                   <table class="table table-striped">
                                        ...
                                        <tbody>
                                        <?php 
                                            if ($data['usia']>='17' and $data['status_cetak']==0) {
                                                # code...
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Penduduk" href="suratktp.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-print"></span></a></td>
                                          </tr>
                                          <?php
                                          }
                                          }
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <section class="panel">
                                            <header class="panel-heading">
                                                ...
                                                <?php
                                                $tampil=$conn->query("SELECT id,nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and YEAR(curdate()) - YEAR(tgl_lahir)='17' and MONTH(tgl_lahir) = MONTH(curdate()) and DAY(tgl_lahir) <= DAY(curdate())  ") ; 
                                                ...
                                                <!-- <?php
                                                $tampil=$conn->query("select * from data_kk order by id desc limit 1");
                                                ...
                                                ?>
                                                    <div class="alert alert-success">
                                                        ...
                                                        <strong><?php echo $data3['nama']; ?></strong>, Telah membuat Kartu Keluarga.
                                                    </div>
                                                <?php } ?> -->

                                                <?php
                                                $tampil=$conn->query("SELECT * from data_penduduk where  YEAR(curdate()) = YEAR(tgl_lahir) and MONTH(tgl_lahir) = MONTH(curdate()) and DAY(tgl_lahir) = DAY(curdate())  ");
                                                ...
                                                <?php
                                                $tampil1=$conn->query("SELECT data_penduduk.nik, data_penduduk.nama, data_kematian.tgl_mati, data_kematian.tmpt_makam FROM data_penduduk, data_kematian WHERE data_penduduk.id = data_kematian.id_kematian order by id desc limit 1");
                    ...
                    <div class="row">
                        ...
                        $tampil=$conn->query("SELECT * from data_penduduk,data_migrasi where ket = 'hidup' and asal = 'pendatang' order by id desc limit 5");
                                ...
                                <ul class="list-group teammates">
                                    <li class="list-group-item">
                                        ...
                                        <a href="datamigrasi.php"><?php echo $data1['nama']; ?></a>
																				<a href="datamigrasi.php"><?php echo $data1['tgl_masuk']; ?></a>
                                    </li>
                                </ul>
                               <?php } ?>
                          ...
                          <section class="panel tasks-widget">
                            ...
                            <div class="panel-body">
                              ...
                              <div class="task-content">
                                  ...
                                  <ul class="task-list">
                                  <?php
                                  $tampil=$conn->query("SELECT data_penduduk.nik, data_penduduk.nama, data_mutasi.tgl_keluar, data_mutasi.alamat_mutasi,data_mutasi.rtrw_mutasi,data_mutasi.desa_mutasi,data_mutasi.kecamatan_mutasi FROM data_penduduk, data_mutasi WHERE data_penduduk.id = data_mutasi.id_mutasi order by id desc limit 5");
                                  ...
                                  ?>
                                      <li>
                                          ...
                                          <div class="task-title">
                                              ...
                                              <span class="label label-primary"><?php echo $data6['tgl_keluar']; ?></span>
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="http://www.facebook/ngihiy.com" target="_blank">Alpha.IT</a> 2017
                </div>
            </aside><!-- /.right-side -->
